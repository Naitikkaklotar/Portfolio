...
<body>
  <nav id="desktop-nav">
    <div class="logo">Naitik Kaklator</div>
    <div>
      <ul class="nav-links">
  ...
  <section id="profile">
    <div class="section__pic-container">
      <img src="./assets/profile-pic.png" alt="naitik's picture" />
    </div>
    <div class="section__text">
      <p class="section__text__p1">Hello, I'm</p>
      <h1 class="title">Naitik Kaklator</h1>
      <p class="section__text__p2">Frontend Developer</p>
      <div class="btn-container">
        <button class="btn btn-color-2" onclick="window.open('./assets/nk.pdf')">
          Download CV
        </button>
  ...
  <section id="about">
    ...
    <div class="section-container">
      <div class="section__pic-container">
        <img src="./assets/aman.jpg" alt="Profile picture" class="about-pic" />
      </div>
    ...
    <div class=" details-container">
      ...
      <form action="form.php" method= "POST">
        <div style="width:100%">
          ...
          <input type="text"  style="width:86%; padding:1rem" name="name" class="contact-info-upper-container" placeholder="Enter your name" required>
          <input type="email"  style="width:86%; padding:1rem" name="email" class="contact-info-upper-container" placeholder="Enter your email" required>
          <input type="text"  style="width:86%; padding:1rem" name="message" class="contact-info-upper-container" placeholder="Enter your messsage" required>
          <input class="btn" style="border:none; cursor:pointer" type="submit"></button>
        </div>
  ...
  <nav>
      ...
      <p>Copyright &#169; 2023 Naitik. All Rights Reserved.</p>
  </footer>
